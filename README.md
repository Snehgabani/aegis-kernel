...
[![Tests](https://img.shields.io/badge/tests-527%2F527%20passing-brightgreen.svg)](https://github.com/Snehgabani/aegis-kernel/actions)
...
| :--- | :--- | :--- | :--- |
| **TypeScript / Node.js** | **Native Core Engine** | Multi-dialect AST parsing, JSON schema compilation, Merkle audit chain, Gateway, CLI, Live Studio | **527/527 tests (72 suites)** |
...
npm test             # 527/527 tests (72 suites)
```
...
| **Test Suite (72 files)** | Full functional correctness & multi-dialect invariant verification | **527 / 527 passing (72 suites)** |
