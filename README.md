...
[![Tests](https://img.shields.io/badge/tests-642%20passing-brightgreen.svg)](https://github.com/Snehgabani/aegis-kernel/actions)
...
| Test suite | 86 TS files + Python/Go/Rust suites | 642/642 TS, 11/11 Py, 17/17 Go, 8/8 Rust passing |
...
npm test        # 642/642 TypeScript tests across 86 files (+11 Python, 17 Go, 8 Rust)
```
