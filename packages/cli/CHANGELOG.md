...
* **cli:** add 'aegis audit-report' command for instant SOC 2 / ISO 42001 risk assessments and Drata/Vanta upsell ([16216f7](https://github.com/Snehgabani/aegis-kernel/commit/16216f750867e5ac5da316f59208e11f258a5434))
* **cli:** add aegis compliance export and explain commands, complete vscode-extension package setup ([390f88c](https://github.com/Snehgabani/aegis-kernel/commit/390f88cb115401b77571ff80057fbf92770c9bf6))
...
* **diagnostics:** add tool invariant usage tracker, shadow tool discovery, and aegis tools CLI scorecard ([097ad60](https://github.com/Snehgabani/aegis-kernel/commit/097ad6078a8f6c74fd742a29e6ede9d856eea1d4))
...
* **evals:** implement academic benchmark suites (InjecAgent, AgentDojo, MCP-Bench), CLI eval runner, and scientific whitepaper ([5a9f5d8](https://github.com/Snehgabani/aegis-kernel/commit/5a9f5d8dfb28c83cb35c676d12624f31efe76f6d))
...
* **mcp:** 'aegis scan-mcp' — MCP server inventory security audit (OWASP MCP Top 10 wedge) ([4a93f0d](https://github.com/Snehgabani/aegis-kernel/commit/4a93f0de4375310800e9939ba0829f68f0afe4ea))
...
* **telemetry:** add privacy-preserving telemetry collector, crash fingerprinting, and aegis stats CLI dashboard ([beb07c9](https://github.com/Snehgabani/aegis-kernel/commit/beb07c9d24018c3c1dd0bf50212d4890b7d1e078))
...
* **ci:** correct actions versions, add js-yaml to cli dependencies, and fix osv-scanner flags ([0fbe0b7](https://github.com/Snehgabani/aegis-kernel/commit/0fbe0b76f354c24d3636b041436364e7318c2bd5))
* **ci:** resolve ESM module resolution in matrix workflow and doctor diagnostic check ([5622087](https://github.com/Snehgabani/aegis-kernel/commit/5622087dabf00cfd6f11280b0b036ca9bab8eb04))
...
* **cli:** ensure zero-dependency standalone CLI bundling and complete Inspect AI wiring ([ec3df67](https://github.com/Snehgabani/aegis-kernel/commit/ec3df67791944fabe4bab527a907f25a8357527c))
* **cli:** modernize CLI bin entry to ESM with updated test suite ([1860d16](https://github.com/Snehgabani/aegis-kernel/commit/1860d161dbe1c47ed477313ed1e70cac8643e0fa))
* **cli:** resolve unused filePath parameter, yaml.load method, and add JIT warmup in trajectory-stress ([980677e](https://github.com/Snehgabani/aegis-kernel/commit/980677e02fc6cc01495449afc25064278fbee5b4))
...
* **deps:** pin commander to ^13.1.0 and add continue-on-error to auto-merge approval ([198572b](https://github.com/Snehgabani/aegis-kernel/commit/198572b38796f56b8cd122f80ab77cee0bb6d368))
...
* **legal:** add TELEMETRY.md and PRIVACY.md under GDPR and EU AI Act compliance ([f4d3970](https://github.com/Snehgabani/aegis-kernel/commit/f4d397013967b9b5a04839f146e0d3ea98f6ba96))
* synchronize benchmark disclosures, test badges, and auditor metrics across all documentation ([b95f70b](https://github.com/Snehgabani/aegis-kernel/commit/b95f70bb30d746b1969b8c9b56c218930ab4606c))
