...
## [1.1.1](https://github.com/Snehgabani/aegis-kernel/compare/aegis-kernel@vv1.1.0...aegis-kernel@vv1.1.1) (2026-08-21)
...
## [1.1.0](https://github.com/Snehgabani/aegis-kernel/compare/aegis-kernel@vv1.0.1...aegis-kernel@vv1.1.0) (2026-08-21)
...
* **security:** resolve Socket.dev alerts and eliminate transitive block-buffer CVE ([7cfcb9f](https://github.com/Snehgabani/aegis-kernel/commit/7cfcb9fbf25d24a754ef5c495e6216ace58bf8d3))
