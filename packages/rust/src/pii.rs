...
impl PiiChecker {
    pub fn new() -> Self {
        ...
        default_patterns.insert(
            "GENERIC_BEARER".to_string(),
            Regex::new(r"\bBearer\s+[A-Za-z0-9\-_.]{15,}\b").unwrap(),
        );
        default_patterns.insert(
            "JWT_TOKEN".to_string(),
        ...
        default_patterns.insert(
            ...
            Regex::new(r"\bSG\.[0-9a-zA-Z_-]{16,32}\.[0-9a-zA-Z_-]{32,64}\b").unwrap(),
        );
        default_patterns.insert(
            "AZURE_KEY".to_string(),
            Regex::new(r"(?i)\b(?:secret|api_key)_[a-zA-Z0-9_]{10,}\b").unwrap(),
        );
        default_patterns.insert(
        ...
        default_patterns.insert(
            ...
            Regex::new(r"(?i)\bDriver License:\s*[A-Z0-9]{6,10}\b").unwrap(),
        );
        default_patterns.insert(
        ...
        default_patterns.insert(
            "CREDIT_CARD_CVV".to_string(),
            Regex::new(r"(?i)\b(?:cvv|cvc|cvn|cid)\s*[:=]\s*\d{3,4}\b").unwrap(),
        );
        ...
        default_patterns.insert(
            ...
            Regex::new(
                r"(?i)\b(?:rm\s+-(?:r|f|rf|fr)\s+[/\\*]|mkfs|dd\s+if=|:\(\)\s*\{\s*:\|:&\s*\};:)",
            )
            .unwrap(),
        );
        ...
        default_patterns.insert(
            ...
            Regex::new(r"\b(?:CANARY-[A-Za-z0-9_-]{12,}|FLAG\{[A-Za-z0-9_-]{8,}\})\b").unwrap(),
        );
        default_patterns.insert(
            "INTERNATIONAL_PHONE".to_string(),
            Regex::new(r"\+(?:[0-9][ -]?){6,14}[0-9]").unwrap(),
        );
        default_patterns.insert(
            "IBAN".to_string(),
            Regex::new(r"\b[A-Z]{2}[0-9]{2}[ -]?(?:[A-Z0-9]{4}[ -]?){1,7}[A-Z0-9]{1,4}\b").unwrap(),
        );
