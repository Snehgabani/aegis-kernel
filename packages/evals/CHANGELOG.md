...
## [1.1.0](https://github.com/Snehgabani/aegis-kernel/compare/evals@vv1.0.1...evals@vv1.1.0) (2026-08-21)
...
* **grc:** Drata & Vanta continuous compliance connector and UK AISI Inspect AI AgentHarm expansion ([31f10fb](https://github.com/Snehgabani/aegis-kernel/commit/31f10fb2e0dc914824650ac04428d4e49e1899de))
...
* **ci:** resolve all 5 GitHub Actions workflow failures — WASM assertion, benchmark tolerance, gitleaks ignore, Docker concurrency, nightly audit ([94ca910](https://github.com/Snehgabani/aegis-kernel/commit/94ca910d3a47b7ace6b751d158459159d0d088f0))
...
* **evals:** calibrate trajectory stress drift tolerance for CI virtual machines ([51f7d91](https://github.com/Snehgabani/aegis-kernel/commit/51f7d9148d9b62a2ac167fc606b3893cee88ec50))
...
* formalize academic bibliography and dataset fair-use attribution ([b166aaa](https://github.com/Snehgabani/aegis-kernel/commit/b166aaa829a75b27d12889cf39dea4e0ea35d9eb))
